...
export const metadata = {
  title: 'Software Comparisons | Iron Peak Solutions',
      ...
      <section className="bg-white border-b border-slate-200 py-16 md:py-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 md:px-6 text-center max-w-4xl relative z-10">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold text-slate-900 mb-6 tracking-tight">
            Software <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-600 to-orange-600">Comparisons</span>
          </h1>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {comparisons.map((comparison) => (
            <Link
              ...
              className="group block bg-white rounded-2xl border border-slate-200 shadow-sm hover:shadow-lg hover:border-amber-200 transition-all overflow-hidden"
            >
              {/* VS Header */}
              ...
              {/* Content */}
              <div className="p-6">
                <h2 className="text-lg font-bold text-slate-900 mb-3 group-hover:text-amber-600 transition-colors line-clamp-2">
                  {comparison.title}
                </h2>
