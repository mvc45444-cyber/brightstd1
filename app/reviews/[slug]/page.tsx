    ...
    <div className="min-h-screen bg-slate-50">
          ...
          <div className="max-w-4xl">
            ...
            <div className="flex flex-wrap items-center gap-6">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 bg-amber-600 hover:bg-amber-700 text-white font-semibold py-2.5 px-6 rounded-xl transition-colors shadow-sm"
              >
            ...
            <div className="sticky top-24 space-y-6">
              ...
              <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm">
                ...
                <a
                  ...
                  target="_blank"
                  rel="nofollow sponsored noopener noreferrer"
                  className="flex items-center justify-center gap-2 bg-amber-600 hover:bg-amber-700 text-white font-semibold py-3 px-4 rounded-xl transition-colors w-full"
                >
                  Visit Website
                  <ExternalLink className="w-4 h-4" />
                </a>
              ...
              <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm">
                ...
                <div className="space-y-2">
                  <Link
                    href="/reviews"
                    className="flex items-center justify-between text-slate-600 hover:text-amber-600 transition-colors text-sm py-2"
                  >
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-slate-200 p-4 lg:hidden z-50">
        <a
          ...
          target="_blank"
          rel="nofollow sponsored noopener noreferrer"
          className="flex items-center justify-center gap-2 bg-amber-600 hover:bg-amber-700 text-white font-semibold py-3 px-6 rounded-xl transition-colors w-full"
        >
          Visit {review.productName}
          <ExternalLink className="w-4 h-4" />
        </a>
