    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <header className="bg-white border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <Link
            href="/blog"
            className="inline-flex items-center text-slate-500 hover:text-amber-600 transition-colors text-sm font-medium"
          >
            ...
            {post.author && (
              <div className="bg-white rounded-2xl border border-slate-200 p-6 md:p-8 shadow-sm mt-8">
                <div className="flex items-center gap-4">
                  <div className="w-14 h-14 bg-gradient-to-br from-blue-500 to-orange-600 rounded-full flex items-center justify-center text-white font-bold text-xl">
                    {post.author.charAt(0)}
                  </div>
                  <div>
                    <h3 className="font-bold text-slate-900">Written by {post.author}</h3>
                    <p className="text-sm text-slate-500">Software Reviewer at Iron Peak Solutions</p>
                  </div>
                </div>
              </div>
            )}
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                  {relatedPosts.map((related) => (
                    <Link
                      ...
                      className="bg-white rounded-xl border border-slate-200 overflow-hidden shadow-sm hover:shadow-md hover:border-amber-200 transition-all group"
                    >
                      ...
                      <div className="p-4">
                        ...
                        <h3 className="font-bold text-slate-900 group-hover:text-amber-600 transition-colors line-clamp-2 text-sm">
                          {related.title}
                        </h3>
                      </div>
                    </Link>
            ...
            <div className="sticky top-24 space-y-6">
              ...
              <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm">
                ...
                <div className="space-y-1">
                  <Link
                    href="/blog"
                    className="flex items-center justify-between text-slate-600 hover:text-amber-600 transition-colors text-sm py-2.5 px-3 rounded-lg hover:bg-slate-50"
                  >
              ...
              <div className="bg-slate-900 rounded-2xl p-6 text-white">
                ...
                <Link
                  href="/reviews"
                  className="inline-flex items-center gap-2 bg-amber-600 hover:bg-amber-700 text-white font-semibold py-2.5 px-4 rounded-xl transition-colors text-sm w-full justify-center"
                >
                  Browse Reviews
