...
export const metadata = {
  title: 'Editorial Policy | Iron Peak Solutions',
      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="bg-white p-8 md:p-12 rounded-2xl shadow-sm border border-slate-200 prose prose-slate max-w-none">
          <p className="lead text-lg text-slate-600 mb-8">
            At Iron Peak Solutions, our mission is to help you find the best software for your business. We believe that trust is our most valuable asset. This policy outlines our standards for independence, accuracy, and transparency.
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-8 my-10 not-prose">
             ...
             <div className="text-center p-6 bg-slate-50 rounded-xl">
               <Scale className="w-8 h-8 mx-auto text-amber-600 mb-3" />
             ...
             <div className="text-center p-6 bg-slate-50 rounded-xl">
               <DollarSign className="w-8 h-8 mx-auto text-amber-600 mb-3" />
          ...
          <p className="text-slate-700">
             To keep our content free, we may earn a commission when you click on links to some of the products we review. This never influences our editorial content or ratings. <Link href="/affiliate-disclosure" className="text-amber-600 hover:underline">Read our full Affiliate Disclosure</Link>.
          </p>

          <h2 className="text-2xl font-bold text-slate-900 mt-8 mb-4">Corrections & Updates</h2>
          <p className="text-slate-700">
             Software changes fast. If you spot outdated information, please <Link href="/contact" className="text-amber-600 hover:underline">contact us</Link>. We regularly update our content to ensure it remains relevant and accurate.
          </p>
