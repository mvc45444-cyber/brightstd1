...
export const metadata = {
  title: 'How We Review Software | Iron Peak Solutions',
    ...
    <div className="bg-slate-50 min-h-screen py-16">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="bg-white p-8 md:p-12 rounded-2xl shadow-sm border border-slate-200 prose prose-slate max-w-none">
          <div className="flex items-center gap-4 mb-8 bg-amber-50 p-6 rounded-xl border border-amber-100">
            <Microscope className="w-10 h-10 text-amber-600 flex-shrink-0" />
            <div>
