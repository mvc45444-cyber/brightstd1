      ...
      <div className="container mx-auto px-4 md:px-6 h-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <div className="group relative">
            <button className="flex items-center gap-1 text-sm font-medium text-slate-600 hover:text-amber-600 transition-colors py-2">
            ...
            <div className="absolute top-full left-0 w-64 bg-white border border-slate-200 shadow-xl rounded-xl p-4 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all transform translate-y-2 group-hover:translate-y-0 duration-200 z-50">
               <div className="flex flex-col gap-2">
                 ...
                 <Link href="/reviews" className="flex items-center gap-3 p-2 hover:bg-slate-50 rounded-lg group/item">
                    <div className="w-8 h-8 bg-amber-100 rounded flex items-center justify-center text-amber-600 group-hover/item:text-amber-700">
                       <Rocket className="w-4 h-4" />
                    </div>
                    <div>
                        <div className="text-sm font-bold text-slate-700 group-hover/item:text-amber-600">All Reviews</div>
                        <div className="text-xs text-slate-500">Browse all software</div>
                    </div>
                 </Link>
                 <Link href="/reviews/payroll" className="block px-2 py-1.5 text-sm text-slate-600 hover:text-amber-600 hover:bg-slate-50 rounded">Payroll Software</Link>
                 <Link href="/reviews/crm" className="block px-2 py-1.5 text-sm text-slate-600 hover:text-amber-600 hover:bg-slate-50 rounded">CRM Software</Link>
                 <Link href="/reviews/project-management" className="block px-2 py-1.5 text-sm text-slate-600 hover:text-amber-600 hover:bg-slate-50 rounded">Project Management</Link>
                 <Link href="/reviews/marketing" className="block px-2 py-1.5 text-sm text-slate-600 hover:text-amber-600 hover:bg-slate-50 rounded">Marketing Tools</Link>
               </div>
            </div>
          </div>
          ...
          <div className="group relative">
            ...
            <div className="absolute top-full left-0 w-64 bg-white border border-slate-200 shadow-xl rounded-xl p-4 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all transform translate-y-2 group-hover:translate-y-0 duration-200 z-50">
               <div className="flex flex-col gap-2">
                 ...
                 <Link href="/comparisons/hubspot-vs-salesforce" className="block px-2 py-1.5 text-sm text-slate-600 hover:text-amber-600 hover:bg-slate-50 rounded">HubSpot vs Salesforce</Link>
               </div>
            </div>
          </div>
          ...
          <div className="group relative">
            ...
            <div className="absolute top-full left-0 w-64 bg-white border border-slate-200 shadow-xl rounded-xl p-4 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all transform translate-y-2 group-hover:translate-y-0 duration-200 z-50">
               <div className="flex flex-col gap-2">
                 ...
                 <Link href="/blog" className="block px-2 py-1.5 text-sm text-slate-600 hover:text-amber-600 hover:bg-slate-50 rounded">Buying Guides</Link>
                 <Link href="/blog" className="block px-2 py-1.5 text-sm text-slate-600 hover:text-amber-600 hover:bg-slate-50 rounded">SaaS Insights</Link>
               </div>
            </div>
          </div>
          ...
          <div className="group relative">
            ...
            <div className="absolute top-full right-0 w-56 bg-white border border-slate-200 shadow-xl rounded-xl p-4 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all transform translate-y-2 group-hover:translate-y-0 duration-200 z-50">
               <div className="flex flex-col gap-2">
                 ...
                 <Link href="/about" className="block px-2 py-1.5 text-sm text-slate-600 hover:text-amber-600 hover:bg-slate-50 rounded">How We Review</Link>
                 <Link href="/affiliate-disclosure" className="block px-2 py-1.5 text-sm text-slate-600 hover:text-amber-600 hover:bg-slate-50 rounded">Editorial Policy</Link>
               </div>
            </div>
          </div>
          ...
          <div className="group relative">
             ...
             <div className="absolute top-full right-0 w-64 bg-slate-900 text-white text-xs p-3 rounded-lg shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all transform translate-y-2 group-hover:translate-y-0 duration-200 z-50">
               ...
               <Link href="/affiliate-disclosure" className="underline hover:text-amber-300">Read Policy</Link>
             </div>
          </div>

          {/* Explore CTA */}
          <Link href="/explore" className="bg-amber-600 text-white px-5 py-2.5 rounded-full text-sm font-bold hover:bg-amber-700 transition-all shadow hover:shadow-lg hover:-translate-y-0.5 ml-2">
            Explore SaaS
          </Link>
        </div>
        ...
        mobileMenuOpen ? "translate-x-0" : "translate-x-full"
         ...
         <div className="container mx-auto px-4 py-8 flex flex-col gap-8">
            ...
            <div className="pb-4 border-b border-slate-100">
               <Link href="/explore" onClick={closeMobileMenu} className="w-full block text-center bg-amber-600 text-white px-5 py-3 rounded-xl text-lg font-bold shadow-md hover:bg-amber-700 transition-colors">
                  Explore SaaS
               </Link>
            </div>
            ...
            <div className="space-y-4">
               <h3 className="font-bold text-slate-900 text-lg flex items-center gap-2">
                  <Rocket className="w-5 h-5 text-amber-600" /> Reviews
               </h3>
