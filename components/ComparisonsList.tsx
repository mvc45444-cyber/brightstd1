      ...
      {comparisons.length > 0 ? (
        comparisons.map((comp) => (
          <motion.div key={comp.slug} variants={item}>
            <Link href={`/comparisons/${comp.slug}`} className="group block bg-white rounded-xl border border-slate-200 p-8 shadow-sm hover:shadow-md hover:border-amber-200 transition-all h-full flex flex-col justify-between">
              <div>
              ...
              <span className="text-amber-600 font-bold flex items-center gap-2 mt-auto">
